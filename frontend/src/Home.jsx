...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const { data: { key } } = await axios.get("http://192.168.1.113:4000/api/getkey")

        const { data: { order } } = await axios.post("http://192.168.1.113:4000/api/checkout", {
            amount
        })
        ...
        const options = {
          ...
          //  image: "https://avatars.githubusercontent.com/u/25058652?v=4",
            order_id: order.id,
            callback_url: "http://192.168.1.113:4000/api/paymentverification",
            prefill: {
                name: "Gaurav Kumar",
